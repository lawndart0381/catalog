...
item1 = Item(name="Elk Hair Caddis",
             ...
             price="$3.99", picture="elkhair.jpg",
...
item2 = Item(name="Parachute Adams",
             ...
             price="$3.99", picture="parachute.jpg",
             category=category1, user=user1)
session.add(item2)
session.commit()
...
item5 = Item(name="Fat Albert",
             ...
             price="$3.49", picture="fat_albert.jpg",
             category=category1, user=user1)
session.add(item5)
session.commit()
...
item1 = Item(name="Hunchback Scud",
             ...
             price="$5.99", picture="scud.jpg", category=category2, user=user1)
session.add(item1)
session.commit()

item2 = Item(name="Pheasant Tail Nymph",
             description="Popular all-purpose pattern!", price="$2.99",
             picture="pheasant_tail.jpg", category=category2, user=user1)
session.add(item2)
session.commit()
...
item3 = Item(name="Rainbow Warrior",
             ...
             price="$3.49",
             picture="rainbow_warrior.jpg", category=category2, user=user1)
session.add(item3)
session.commit()

item4 = Item(name="Zebra Midge",
             description="Classic pattern that trout go crazy for!",
             price="$3.99", picture="zebramidge.jpg",
...
item1 = Item(name="Signature Fly Rod",
             ...
             price="$250.00", picture="flyrod.jpg",
...
item2 = Item(name="Classic Fly Rod",
             ...
             price="$150.00", picture="flyrod2.jpg",
             category=category3, user=user1)
session.add(item2)
session.commit()
...
item3 = Item(name="SWS Fly Rod",
             ...
             price="$650.00", picture="flyrod3.jpg",
             category=category3, user=user1)
session.add(item3)
session.commit()
...
item4 = Item(name="Eagle Fly Rod",
             ...
             price="$99.00", picture="flyrod4.jpg",
             category=category3, user=user1)
session.add(item4)
session.commit()
...
item5 = Item(name="Santo Fly Rod",
             ...
             price="$130.00", picture="flyrod1.jpg",
             category=category3, user=user1)
session.add(item5)
session.commit()
...
item2 = Item(name="Speedster Reel",
             ...
             price="$175.00", picture="reel2.jpg",
             category=category4, user=user1)
session.add(item2)
session.commit()
...
item5 = Item(name="Remix Fly Reel",
             ...
             price="$180.00", picture="reel1.jpg",
             category=category4, user=user1)
session.add(item5)
session.commit()
...
item1 = Item(name="Premium Chest Waders",
             ...
             price="$121.99", picture="chest_wader.jpg",
...
item2 = Item(name="Bootfoot Chest Waders",
             ...
             price="$99.99", picture="chest_wader2.jpg",
             category=category5, user=user1)
session.add(item2)
session.commit()
...
item3 = Item(name="Wading Pants",
             ...
             price="$299.00", picture="wader_pants.jpg",
             category=category5, user=user1)
session.add(item3)
session.commit()
...
item4 = Item(name="Hip Boots",
             ...
             price="$99.00", picture="hip_boots.jpg",
             category=category5, user=user1)
session.add(item4)
session.commit()
...
item5 = Item(name="Stockingfoot Hip Waders",
             ...
             price="$89.99", picture="hip_wader.jpg",
             category=category5, user=user1)
session.add(item5)
session.commit()
...
item1 = Item(name="Ultralight Boots",
             ...
             price="$75.99", picture="boots1.jpg",
...
item2 = Item(name="Guide Boots",
             ...
             price="$199.99", picture="boots2.jpg",
             category=category6, user=user1)
session.add(item2)
session.commit()
...
item3 = Item(name="Hightop Sneaker Boots",
             ...
             price="$99.00", picture="boots3.jpg",
             category=category6, user=user1)
session.add(item3)
session.commit()
...
item4 = Item(name="Felt Sole Boots",
             ...
             price="$99.00", picture="boots4.jpg",
             category=category6, user=user1)
session.add(item4)
session.commit()
...
item5 = Item(name="Lug Sole Boots",
             ...
             price="$89.99", picture="boots5.jpg",
             category=category6, user=user1)
session.add(item5)
session.commit()
...
item1 = Item(name="Classic Float",
             ...
             price="$219.99", picture="float1.jpg",
...
item2 = Item(name="Caddis Float",
             ...
             price="$99.99", picture="float2.jpg",
             category=category7, user=user1)
session.add(item2)
session.commit()
...
item3 = Item(name="Fish Cat",
             ...
             price="$219.00", picture="float3.jpg",
             category=category7, user=user1)
session.add(item3)
session.commit()
...
item4 = Item(name="Float Combo Pack",
             ...
             price="$159.99", picture="float4.jpg",
             category=category7, user=user1)
session.add(item4)
session.commit()
...
item5 = Item(name="Caddis Premier Float",
             ...
             price="$198.99", picture="float5.jpg",
             category=category7, user=user1)
session.add(item5)
session.commit()
...
item1 = Item(name="Fly-Tying Bag",
             ...
             price="$25.99", picture="flytiebag.jpg",
...
item2 = Item(name="Duffle Bag",
             ...
             price="$169.99", picture="duffle.jpg",
             category=category8, user=user1)
session.add(item2)
session.commit()
...
item3 = Item(name="Fishing Vest",
             ...
             picture="vest.jpg", category=category8, user=user1)
session.add(item3)
session.commit()

item4 = Item(name="Chest Pack",
             description="The perfect tackle for the minimalist!",
             price="$19.00", picture="chestpack.jpg",
             category=category8, user=user1)
session.add(item4)
session.commit()
...
item5 = Item(name="Sling Pack",
             ...
             price="$89.99", picture="slingbag.jpg",
             category=category8, user=user1)
session.add(item5)
session.commit()
